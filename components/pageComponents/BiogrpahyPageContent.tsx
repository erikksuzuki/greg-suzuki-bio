  ...
  return (
    <div className="block p-4">
      <p className="block mb-4">
        ...
        Mission College. During these years, he met up with his old friend,
        Osamu Kitajima, regarded by many as the original pioneer of blending
        eastern and western music, who soon became his mentor. After graduating
        as a music major, Greg became one of the first Japanese musicians to
        register in the Los Angeles Music Union. Based in Los Angeles, he began
        his musical career.
      </p>
      <p className="block mb-4">
